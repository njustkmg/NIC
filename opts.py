...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='data/uniform_noise_60/cocotalk.json',
    ...
    parser.add_argument('--input_label_h5', type=str, default='data/uniform_noise_60/cocotalk_label.h5',
